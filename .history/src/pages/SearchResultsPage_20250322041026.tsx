      ...
      <div className="flex flex-col md:flex-row gap-8">
        ...
        <div className="w-full md:w-3/4">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
            <ResultsCounter total={quotes.length + books.length} searchTerm={searchTerm} />
          ...
          {loading && page === 1 ? (
            ...
            <div className="space-y-8">
              ...
              {quotes.length > 0 && (
                <section>
                  <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">Quotes</h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {quotes.map(quote => (
                      <QuoteCard
                        key={quote.id}
              ...
              {/* No Results Message */}
              {!loading && quotes.length === 0 && books.length === 0 && (
          ...
          {/* Load More Button */}
          {(quotes.length > 0 || books.length > 0) && !loading && (
