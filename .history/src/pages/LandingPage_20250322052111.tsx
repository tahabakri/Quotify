...
import { AuthorCard, AuthorCardSkeleton } from '../components/Author/AuthorCard';
...
interface LandingCollection extends Collection {
  curator: {
    id: string;
    name: string;
    imageUrl?: string;
...
export const LandingPage: React.FC = () => {
  ...
  const [featuredCollections, setFeaturedCollections] = useState<LandingCollection[]>([]);
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Mock featured collections with all required Collection properties
