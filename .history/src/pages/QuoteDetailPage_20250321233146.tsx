...
import type { BackgroundMood } from '../services/deepai/types';
...
export function QuoteDetailPage() {
  ...
  const handleShare = async () => {
    ...
    try {
      await navigator.share({
        title: `Quote from ${quote.book?.title || 'Unknown Book'}`,
        text: quote.content,
  ...
  const handleGenerateImage = async () => {
    ...
    try {
      ...
      const mood: BackgroundMood = document.documentElement.classList.contains('dark') ? 'dark' : 'light';
