...
export const CollectionCard = ({ collection }: CollectionCardProps) => {
  ...
  const getBackgroundClass = (color?: string) => {
    ...
    return Object.keys(colors).includes(color) ? colors[color as keyof typeof colors] : colors.default;
  };
  ...
  return (
    ...
    >
      <div className="relative h-48">
        <div 
          className={`w-full h-full ${getBackgroundClass(theme?.backgroundColor)} ${getTextColorClass(theme?.textColor)}`}
        />
