...
// Custom type for button props that handles both Motion and Slot
...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ 
    ...
    // Replace children with our button content
    if (asChild) {
      return React.cloneElement(button, {}, buttonContent)
    }
