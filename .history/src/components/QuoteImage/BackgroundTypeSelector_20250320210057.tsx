    ...
    >
      {options.map((option, index) => {
        ...
        return React.createElement('li', {
          ...
          children: [
            <div key="content" className="flex flex-col items-start gap-2">
            ...
            isRecommended && (
              <span key="recommended" className="absolute top-2 right-2 text-yellow-600 text-sm font-medium">
                Recommended
              </span>
            )
          ]
      ...
      <section>
        <div className="flex items-center justify-between mb-4">
          ...
          {React.createElement('button', {
            ...
            type: "button",
            children: `${isCustomPromptVisible ? 'Hide' : 'Show'} Custom Prompt`
          })}
        </div>
