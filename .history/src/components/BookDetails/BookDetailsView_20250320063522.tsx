    ...
    >
      ...
      >
        ...
        <div className="p-4 border-b border-gray-200 dark:border-dark-100 flex items-center">
          ...
          <h2 id="book-details-title" className="ml-2 text-xl font-semibold text-gray-900 dark:text-white">
            Book Details
          </h2>
        </div>
        ...
        <div className="flex-1 overflow-y-auto">
          ...
          <div className="p-8">
            ...
            {activeTab === 'quotes' && (
              <div role="tabpanel" aria-labelledby="quotes-tab">
                <QuoteBrowser bookId={book.id} bookTitle={book.title} className="mt-2" />
              </div>
            )}
          </div>
        </div>
