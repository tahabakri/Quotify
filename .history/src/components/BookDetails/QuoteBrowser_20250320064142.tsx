  ...
  const handleGenerateQuote = async () => {
    ...
    try {
      ...
      if (!generatedQuote.trim()) {
        throw new Error('Generated quote is empty. Please try again.');
      }
      ...
      const errorMessage = err instanceof Error ? err.message : 'Failed to generate quote. Please try again.';
